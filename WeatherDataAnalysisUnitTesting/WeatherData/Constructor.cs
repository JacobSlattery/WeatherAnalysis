...
namespace WeatherDataAnalysisUnitTesting.WeatherData
{
    ...
    public class Constructor
    {
        ...
        {
            Assert.IsNotNull(new WeatherDataAnalysis.Model.WeatherData(new DateTime(), 0, 0));
        }
        ...
        {
            new WeatherDataAnalysis.Model.WeatherData(new DateTime(), 0, 1);
        }
        ...
        public void TestParamsAreSetCorrectly()
        {
            ...
            const int low = -10023;
            var weatherData = new WeatherDataAnalysis.Model.WeatherData(date, high, low);
